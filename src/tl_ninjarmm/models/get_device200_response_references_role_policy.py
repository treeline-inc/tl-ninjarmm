...
class GetDevice200ResponseReferencesRolePolicy(BaseModel):
    """
    ...
    parent_policy_id: Optional[StrictInt] = Field(default=None, description="Parent Policy identifier", alias="parentPolicyId")
    name: Optional[StrictStr] = Field(default=None, description="Name")
    description: Optional[StrictStr] = Field(default=None, description="Description")
    node_class: Optional[StrictStr] = Field(default=None, description="Node Class", alias="nodeClass")
    updated: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Last update timestamp")
    node_class_default: Optional[StrictBool] = Field(default=None, description="Is Default Policy for Node Class", alias="nodeClassDefault")
    ...
    __properties: ClassVar[List[str]] = ["id", "parentPolicyId", "name", "description", "nodeClass", "updated", "nodeClassDefault", "tags", "fields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDevice200ResponseReferencesRolePolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDevice200ResponseReferencesRolePolicy from a dict"""
        if obj is None:
            return None

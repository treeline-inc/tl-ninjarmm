...
class GetIntegrityCheckJobs200ResponseCursor(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "offset", "count", "expires"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetIntegrityCheckJobs200ResponseCursor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetIntegrityCheckJobs200ResponseCursor from a dict"""
        if obj is None:
            return None

...
class DeviceAntivirusStatus(BaseModel):
    """
    ...
    product_state: Optional[StrictStr] = Field(
        default=None, description="Product state", alias="productState"
    )
    definition_status: Optional[StrictStr] = Field(
        default=None, description="Definition Status", alias="definitionStatus"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceAntivirusStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceAntivirusStatus from a dict"""
        if obj is None:
            return None

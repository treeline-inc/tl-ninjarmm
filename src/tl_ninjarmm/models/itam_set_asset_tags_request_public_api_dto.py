...
class ItamSetAssetTagsRequestPublicApiDTO(BaseModel):
    """
    ItamSetAssetTagsRequestPublicApiDTO
    """ # noqa: E501
    tag_ids: Optional[List[StrictInt]] = Field(default=None, description="Array of tag IDS to assign to asset from URL. The tags on the asset will be set to exactly these tags, removing existing tags if necessary", alias="tagIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ItamSetAssetTagsRequestPublicApiDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ItamSetAssetTagsRequestPublicApiDTO from a dict"""
        if obj is None:
            return None

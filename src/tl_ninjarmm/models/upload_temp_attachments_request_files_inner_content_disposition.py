...
class UploadTempAttachmentsRequestFilesInnerContentDisposition(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "parameters", "fileName", "creationDate", "modificationDate", "readDate", "size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UploadTempAttachmentsRequestFilesInnerContentDisposition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UploadTempAttachmentsRequestFilesInnerContentDisposition from a dict"""
        if obj is None:
            return None

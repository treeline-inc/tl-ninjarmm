        ...
        _obj = cls.model_validate(
            {
                ...
                "bodyParts": [BodyPart.from_dict(_item) for _item in obj["bodyParts"]]
                if obj.get("bodyParts") is not None
                else None,
...
from tl_ninjarmm.models.body_part import BodyPart  # noqa: E402

# TODO: Rewrite to not use raise_errors
MultiPart.model_rebuild(raise_errors=False)

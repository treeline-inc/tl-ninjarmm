...
class CreateOrganizationRequestLocationsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "address", "description", "userData", "tags", "fields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOrganizationRequestLocationsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOrganizationRequestLocationsInner from a dict"""
        if obj is None:
            return None

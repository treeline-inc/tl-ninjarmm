...
class Job(BaseModel):
    ...
    def job_status_validate_enum(cls, value):
        ...
        if value not in set(['START_REQUESTED', 'STARTED', 'IN_PROCESS', 'COMPLETED', 'CANCEL_REQUESTED', 'CANCELLED', 'WAITING_FOR_USER_RESPONSE', 'TRIGGERED', 'RESET', 'ACKNOWLEDGED', 'DISABLED']):
            raise ValueError("must be one of enum values ('START_REQUESTED', 'STARTED', 'IN_PROCESS', 'COMPLETED', 'CANCEL_REQUESTED', 'CANCELLED', 'WAITING_FOR_USER_RESPONSE', 'TRIGGERED', 'RESET', 'ACKNOWLEDGED', 'DISABLED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "device": NodeWithDetailedReferences.from_dict(obj["device"]) if obj.get("device") is not None else None,

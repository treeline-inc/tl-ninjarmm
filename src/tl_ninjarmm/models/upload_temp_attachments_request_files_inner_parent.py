...
class UploadTempAttachmentsRequestFilesInnerParent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["contentDisposition", "entity", "headers", "mediaType", "messageBodyWorkers", "parent", "providers", "bodyParts", "parameterizedHeaders"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UploadTempAttachmentsRequestFilesInnerParent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UploadTempAttachmentsRequestFilesInnerParent from a dict"""
        if obj is None:
            return None

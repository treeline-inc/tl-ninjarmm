...
class CreateOrganizationDefaultResponse(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="Organization identifier")
    locations: Optional[List[CreateOrganizationDefaultResponseLocationsInner]] = Field(default=None, description="List of locations")
    ...
    settings: Optional[CreateOrganizationDefaultResponseSettings] = None
    __properties: ClassVar[List[str]] = ["name", "description", "userData", "nodeApprovalMode", "tags", "fields", "id", "locations", "policies", "settings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOrganizationDefaultResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOrganizationDefaultResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "locations": [CreateOrganizationDefaultResponseLocationsInner.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None,
            ...
            "settings": CreateOrganizationDefaultResponseSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj

...
class NodeRole(BaseModel):
    ...
    node_role_parent_id: Optional[StrictInt] = Field(default=None, description="Node Role Parent Id", alias="nodeRoleParentId")
    icon: Optional[StrictStr] = Field(default=None, description="Icon")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "nodeClass", "custom", "chassisType", "created", "tags", "fields", "nodeRoleParentId", "icon"]

...
class VMHost(BaseModel):
    ...
    cpu_mhz: Optional[StrictInt] = Field(default=None, description="CPU Frequency", alias="cpuMhz")
    cpu_model: Optional[StrictStr] = Field(default=None, description="CPU Model", alias="cpuModel")
    ht_active: Optional[StrictBool] = Field(default=None, description="Is Hyper-Threading active?", alias="htActive")
    ht_available: Optional[StrictBool] = Field(default=None, description="Is Hyper-Threading available?", alias="htAvailable")
    last_boot_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Last toot time", alias="lastBootTime")
    memory_size: Optional[StrictInt] = Field(default=None, description="Total memory size (bytes)", alias="memorySize")
    ...
    cpu_packages: Optional[StrictInt] = Field(default=None, description="Number of CPUs", alias="cpuPackages")
    cpu_threads: Optional[StrictInt] = Field(default=None, description="Total number of logical CPU cores", alias="cpuThreads")
    service_tag: Optional[StrictStr] = Field(default=None, description="Service Tag", alias="serviceTag")
    vendor: Optional[StrictStr] = Field(default=None, description="Vendor")
    release_name: Optional[StrictStr] = Field(default=None, description="Release Name", alias="releaseName")
    ...
    __properties: ClassVar[List[str]] = ["id", "parentDeviceId", "organizationId", "locationId", "nodeClass", "nodeRoleId", "rolePolicyId", "policyId", "approvalStatus", "offline", "displayName", "systemName", "dnsName", "netbiosName", "created", "lastContact", "lastUpdate", "userData", "tags", "fields", "maintenance", "references", "ipAddresses", "macAddresses", "publicIP", "notes", "deviceType", "cpuMhz", "cpuModel", "htActive", "htAvailable", "lastBootTime", "memorySize", "model", "name", "cpuCores", "cpuPackages", "cpuThreads", "serviceTag", "vendor", "releaseName", "version", "buildNumber"]

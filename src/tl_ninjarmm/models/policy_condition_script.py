...
class PolicyConditionScript(BaseModel):
    ...
    script_variables: Optional[Annotated[List[PolicyConditionScriptVariable], Field(min_length=0, max_length=20)]] = Field(default=None, description="Policy condition script variables", alias="scriptVariables")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scriptVariables": [PolicyConditionScriptVariable.from_dict(_item) for _item in obj["scriptVariables"]] if obj.get("scriptVariables") is not None else None
        })
        return _obj

...
class GetTags200ResponseTagsInnerCreatedBy(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTags200ResponseTagsInnerCreatedBy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTags200ResponseTagsInnerCreatedBy from a dict"""
        if obj is None:
            return None

...
class PublicScanGroup(BaseModel):
    """
    PublicScanGroup
    """  # noqa: E501
    ...
    third_party_api_tile: Optional[StrictStr] = Field(
        default=None, alias="thirdPartyApiTile"
    )
    device_id_header: Optional[StrictStr] = Field(default=None, alias="deviceIdHeader")
    device_internal_mapping: Optional[StrictStr] = Field(
        default=None, alias="deviceInternalMapping"
    )
    cve_id_header: Optional[StrictStr] = Field(default=None, alias="cveIdHeader")
    last_file_upload_date: Optional[StrictStr] = Field(
        default=None, alias="lastFileUploadDate"
    )
    records_processed: Optional[StrictInt] = Field(
        default=None, alias="recordsProcessed"
    )
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(["COMPLETE", "IN_PROGRESS", "FAILED"]):
            raise ValueError(
                "must be one of enum values ('COMPLETE', 'IN_PROGRESS', 'FAILED')"
            )
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicScanGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicScanGroup from a dict"""
        if obj is None:
            return None

...
class GetContactsDefaultResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "clientId", "clientName", "uid", "firstName", "lastName", "email", "phone", "jobTitle", "displayName", "createTime", "updateTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetContactsDefaultResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetContactsDefaultResponseInner from a dict"""
        if obj is None:
            return None

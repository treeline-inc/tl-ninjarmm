...
class LocationBackupUsageSummary(BaseModel):
    ...
    location_id: Optional[StrictInt] = Field(
        default=None, description="Device location id", alias="locationId"
    )
    location_name: Optional[StrictStr] = Field(
        default=None, description="Device location name", alias="locationName"
    )

...
class GetDocumentTemplatesWithAttributes200ResponseInnerArchivedBy(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "displayName", "deleted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDocumentTemplatesWithAttributes200ResponseInnerArchivedBy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDocumentTemplatesWithAttributes200ResponseInnerArchivedBy from a dict"""
        if obj is None:
            return None

...
class ClientDocumentWithAttributeValuesBulkCreatePublicApiRequest(BaseModel):
    ...
    fields: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Fields")
    ...
    __properties: ClassVar[List[str]] = ["documentName", "documentDescription", "fields", "documentTemplateId", "organizationId"]

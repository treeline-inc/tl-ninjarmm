...
class NewCustomTabPublicApiRequest(BaseModel):
    """
    NewCustomTabPublicApiRequest
    """  # noqa: E501

    name: StrictStr = Field(description="The display name to use for the custom tab")
    ...
    entity_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(
        default=None,
        description="For tab types that require an id to create (currently, only NODE_ROLE types), this field is the ID of the entity",
        alias="entityId",
    )
    items: Optional[List[AttributeFormContentItemPublicApiDTO]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewCustomTabPublicApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewCustomTabPublicApiRequest from a dict"""
        if obj is None:
            return None

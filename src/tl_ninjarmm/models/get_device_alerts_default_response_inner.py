...
class GetDeviceAlertsDefaultResponseInner(BaseModel):
    """
    GetDeviceAlertsDefaultResponseInner
    """ # noqa: E501
    uid: Optional[StrictStr] = Field(default=None, description="Alert UID (activity series UID)")
    ...
    create_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Alert creation timestamp", alias="createTime")
    update_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Alert last updated", alias="updateTime")
    source_type: Optional[StrictStr] = Field(default=None, description="Alert origin", alias="sourceType")
    ...
    subject: Optional[StrictStr] = Field(default=None, description="Alert subject")
    ...
    data: Optional[Dict[str, Any]] = Field(default=None, description="Alert data")
    device: Optional[GetDeviceActiveJobsDefaultResponseInnerDevice] = None
    __properties: ClassVar[List[str]] = ["uid", "deviceId", "message", "createTime", "updateTime", "sourceType", "sourceConfigUid", "sourceName", "subject", "userId", "psaTicketId", "ticketTemplateId", "data", "device"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeviceAlertsDefaultResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeviceAlertsDefaultResponseInner from a dict"""
        if obj is None:
            return None

...
class GetDeviceActiveJobsDefaultResponseInner(BaseModel):
    """
    GetDeviceActiveJobsDefaultResponseInner
    """ # noqa: E501
    uid: Optional[StrictStr] = Field(default=None, description="Task/Job UID (activity series UID)")
    ...
    create_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Job start timestamp", alias="createTime")
    update_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Job last updated", alias="updateTime")
    source_type: Optional[StrictStr] = Field(default=None, description="Job origin", alias="sourceType")
    source_config_uid: Optional[StrictStr] = Field(default=None, description="Source configuration/policy element reference", alias="sourceConfigUid")
    source_name: Optional[StrictStr] = Field(default=None, description="Source configuration/policy element name", alias="sourceName")
    subject: Optional[StrictStr] = Field(default=None, description="Job subject")
    user_id: Optional[StrictInt] = Field(default=None, description="User identifier", alias="userId")
    psa_ticket_id: Optional[Dict[str, Any]] = Field(default=None, description="Related PSA ticket ID", alias="psaTicketId")
    ticket_template_id: Optional[StrictInt] = Field(default=None, description="PSA ticket template", alias="ticketTemplateId")
    ...
    job_result: Optional[StrictStr] = Field(default=None, description="Job result", alias="jobResult")
    job_type: Optional[StrictStr] = Field(default=None, description="Job Type", alias="jobType")
    __properties: ClassVar[List[str]] = ["uid", "deviceId", "message", "createTime", "updateTime", "sourceType", "sourceConfigUid", "sourceName", "subject", "userId", "psaTicketId", "ticketTemplateId", "data", "device", "jobStatus", "jobResult", "jobType"]
    ...
    def job_status_validate_enum(cls, value):
        ...
        if value not in set(['START_REQUESTED', 'STARTED', 'IN_PROCESS', 'COMPLETED', 'CANCEL_REQUESTED', 'CANCELLED', 'TRIGGERED', 'RESET', 'ACKNOWLEDGED', 'DISABLED']):
            raise ValueError("must be one of enum values ('START_REQUESTED', 'STARTED', 'IN_PROCESS', 'COMPLETED', 'CANCEL_REQUESTED', 'CANCELLED', 'TRIGGERED', 'RESET', 'ACKNOWLEDGED', 'DISABLED')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeviceActiveJobsDefaultResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeviceActiveJobsDefaultResponseInner from a dict"""
        if obj is None:
            return None

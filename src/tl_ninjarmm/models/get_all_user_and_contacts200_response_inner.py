...
class GetAllUserAndContacts200ResponseInner(BaseModel):
    """
    GetAllUserAndContacts200ResponseInner
    """ # noqa: E501
    uid: Optional[StrictStr] = Field(default=None, description="Global identifier for the user")
    id: Optional[StrictInt] = Field(default=None, description="User identifier")
    client_id: Optional[StrictInt] = Field(default=None, description="Client identifier", alias="clientId")
    ...
    user_type: Optional[StrictStr] = Field(default=None, description="System User Type", alias="userType")
    natural_id: Optional[StrictStr] = Field(default=None, description="Last User Identifier", alias="naturalId")
    __properties: ClassVar[List[str]] = ["uid", "id", "clientId", "firstName", "lastName", "email", "userType", "naturalId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllUserAndContacts200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllUserAndContacts200ResponseInner from a dict"""
        if obj is None:
            return None

...
class CreateSecureRelatedItemForEntityRequest(BaseModel):
    ...
    totp_secret: Optional[StrictStr] = Field(default=None, description="TOTP Secret", alias="totpSecret")
    __properties: ClassVar[List[str]] = ["name", "url", "notes", "username", "password", "totpSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSecureRelatedItemForEntityRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSecureRelatedItemForEntityRequest from a dict"""
        if obj is None:
            return None

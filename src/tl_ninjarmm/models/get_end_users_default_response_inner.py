...
class GetEndUsersDefaultResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "email", "phone", "enabled", "administrator", "permitAllClients", "notifyAllClients", "mustChangePw", "mfaConfigured", "userType", "invitationStatus", "organizationId", "deviceIds", "tags", "fields", "roles"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetEndUsersDefaultResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetEndUsersDefaultResponseInner from a dict"""
        if obj is None:
            return None

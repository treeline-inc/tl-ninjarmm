...
class CustomFieldPolicyConditionResponse(BaseModel):
    ...
    match_all: Optional[List[PolicyConditionCustomField]] = Field(default=None, description="Custom field value must meet all conditions", alias="matchAll")
    match_any: Optional[List[PolicyConditionCustomField]] = Field(default=None, description="Custom field value must meet any conditions", alias="matchAny")

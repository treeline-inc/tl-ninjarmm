...
class SearchDefaultResponseDevicesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "parentDeviceId", "organizationId", "locationId", "nodeClass", "nodeRoleId", "rolePolicyId", "policyId", "approvalStatus", "offline", "displayName", "systemName", "dnsName", "netbiosName", "created", "lastContact", "lastUpdate", "userData", "tags", "fields", "maintenance", "references", "score", "matchAttr", "matchAttrValue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchDefaultResponseDevicesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchDefaultResponseDevicesInner from a dict"""
        if obj is None:
            return None

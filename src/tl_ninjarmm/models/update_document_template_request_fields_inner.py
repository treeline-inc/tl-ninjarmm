...
class UpdateDocumentTemplateRequestFieldsInner(BaseModel):
    """
    List of fields and ui elements
    """ # noqa: E501
    field_id: Optional[StrictInt] = Field(default=None, description="Field identifier (Used to identify existing fields)", alias="fieldId")
    field_label: Optional[StrictStr] = Field(default=None, description="Field or UI element name", alias="fieldLabel")
    field_name: Optional[StrictStr] = Field(default=None, description="Field name (Immutable except for new fields)", alias="fieldName")
    field_description: Optional[StrictStr] = Field(default=None, description="Field description", alias="fieldDescription")
    field_type: Optional[StrictStr] = Field(default=None, description="Field type (Immutable except for new fields)", alias="fieldType")
    ...
    __properties: ClassVar[List[str]] = ["fieldId", "fieldLabel", "fieldName", "fieldDescription", "fieldType", "fieldTechnicianPermission", "fieldScriptPermission", "fieldApiPermission", "fieldDefaultValue", "fieldContent", "uiElementUid", "uiElementName", "uiElementType", "uiElementValue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateDocumentTemplateRequestFieldsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateDocumentTemplateRequestFieldsInner from a dict"""
        if obj is None:
            return None

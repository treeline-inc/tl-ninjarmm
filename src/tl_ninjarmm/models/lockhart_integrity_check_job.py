...
class LockhartIntegrityCheckJob(BaseModel):
    """
    ...
    job_id: Optional[StrictStr] = Field(
        default=None, description="Job id.", alias="jobId"
    )
    job_start_time: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Job start time.", alias="jobStartTime"
    )
    job_end_time: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Job end time.", alias="jobEndTime"
    )
    job_status: Optional[StrictStr] = Field(
        default=None, description="Job status.", alias="jobStatus"
    )
    plan_guid: Optional[StrictStr] = Field(
        default=None, description="Plan id.", alias="planGuid"
    )
    plan_name: Optional[StrictStr] = Field(
        default=None, description="Plan name.", alias="planName"
    )
    plan_type: Optional[StrictStr] = Field(
        default=None, description="Plan type.", alias="planType"
    )
    total_actual_storage_bytes: Optional[StrictInt] = Field(
        default=None, description="Total bytes", alias="totalActualStorageBytes"
    )
    total_actual_storage_files: Optional[StrictInt] = Field(
        default=None, description="Total files.", alias="totalActualStorageFiles"
    )
    actual_bytes_checked: Optional[StrictInt] = Field(
        default=None, description="Bytes checked.", alias="actualBytesChecked"
    )
    actual_files_checked: Optional[StrictInt] = Field(
        default=None, description="Files checked.", alias="actualFilesChecked"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LockhartIntegrityCheckJob from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LockhartIntegrityCheckJob from a dict"""
        if obj is None:
            return None

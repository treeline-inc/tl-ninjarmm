...
class Script(BaseModel):
    ...
    id: Optional[StrictInt] = Field(
        default=None, description="Custom script identifier (Scripts)"
    )
    uid: Optional[StrictStr] = Field(
        default=None, description="Built-in action identifier (Actions)"
    )
    ...
    category_id: Optional[StrictInt] = Field(
        default=None, description="Script Category identifier", alias="categoryId"
    )

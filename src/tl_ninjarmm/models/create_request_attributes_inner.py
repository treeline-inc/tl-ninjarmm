...
class CreateRequestAttributesInner(BaseModel):
    """
    CreateRequestAttributesInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    attribute_id: StrictInt = Field(description="Attribute identifier", alias="attributeId")
    value: StrictStr = Field(description="Attribute value")
    __properties: ClassVar[List[str]] = ["id", "attributeId", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRequestAttributesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRequestAttributesInner from a dict"""
        if obj is None:
            return None

...
from tl_ninjarmm.models.new_document_attribute_content_public_api import (
...
class NewDocumentItemPublicApiRequest(BaseModel):
    """
    ...
    field_name: StrictStr = Field(
        description="Field name (Immutable value)", alias="fieldName"
    )
    ...
    field_type: Optional[StrictStr] = Field(
        default=None, description="Field type (Immutable value)", alias="fieldType"
    )
    ...
    field_content: Optional[NewDocumentAttributeContentPublicApi] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewDocumentItemPublicApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewDocumentItemPublicApiRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "fieldContent": NewDocumentAttributeContentPublicApi.from_dict(
                    obj["fieldContent"]
                )

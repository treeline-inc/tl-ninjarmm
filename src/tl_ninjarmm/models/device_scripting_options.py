...
class DeviceScriptingOptions(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "categories": [
                    ScriptCategory.from_dict(_item) for _item in obj["categories"]
                ]
                if obj.get("categories") is not None
                else None,
                "scripts": [Script.from_dict(_item) for _item in obj["scripts"]]
                if obj.get("scripts") is not None
                else None,
                "credentials": DeviceCredentialOptions.from_dict(obj["credentials"])

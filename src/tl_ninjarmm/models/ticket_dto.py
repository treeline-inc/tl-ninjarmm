...
class TicketDTO(BaseModel):
    ...
    status: Optional[TicketStatusPublicApiDTO] = None
    ...
    cc_list: Optional[CcList] = Field(default=None, alias="ccList")
    create_time: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="createTime"
    )
    deleted: Optional[StrictBool] = None
    attribute_values: Optional[List[AttributeValueDTO]] = Field(
        default=None, alias="attributeValues"
    )
    additional_assigned_technician_ids: Optional[List[StrictInt]] = Field(
        default=None, alias="additionalAssignedTechnicianIds"
    )
    ...
    def source_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('TECHNICIAN', 'EMAIL', 'WEB_FORM', 'HELP_REQUEST', 'END_USER', 'CONDITION', 'SCHEDULED_SCRIPT', 'ACTIVITY')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "status": TicketStatusPublicApiDTO.from_dict(obj["status"])
                ...
                "tags": obj.get("tags"),
                "ccList": CcList.from_dict(obj["ccList"])
                if obj.get("ccList") is not None
                else None,
                "createTime": obj.get("createTime"),
                "deleted": obj.get("deleted"),
                "attributeValues": [
                    AttributeValueDTO.from_dict(_item)
                    for _item in obj["attributeValues"]
                ]
                if obj.get("attributeValues") is not None
                else None,

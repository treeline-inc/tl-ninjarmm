...
class FeatureSettings(BaseModel):
    ...
    product: Optional[StrictStr] = Field(
        default=None, description="Configured product code"
    )
    enabled: Optional[StrictBool] = Field(default=None, description="Is enabled")
    targets: Optional[List[StrictStr]] = Field(
        default=None, description="Feature deployment targets"
    )
    options: Optional[Dict[str, Dict[str, Any]]] = Field(
        default=None, description="Feature options"
    )

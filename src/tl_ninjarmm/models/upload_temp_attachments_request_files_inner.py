...
class UploadTempAttachmentsRequestFilesInner(BaseModel):
    """
    ...
    parent: Optional[UploadTempAttachmentsRequestFilesInnerParent] = None
    providers: Optional[Dict[str, Any]] = None
    simple: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    value: Optional[StrictStr] = None
    form_data_content_disposition: Optional[UploadTempAttachmentsRequestFilesInnerFormDataContentDisposition] = Field(default=None, alias="formDataContentDisposition")
    ...
    __properties: ClassVar[List[str]] = ["contentDisposition", "entity", "headers", "mediaType", "messageBodyWorkers", "parent", "providers", "simple", "name", "value", "formDataContentDisposition", "parameterizedHeaders"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UploadTempAttachmentsRequestFilesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UploadTempAttachmentsRequestFilesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "parent": UploadTempAttachmentsRequestFilesInnerParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "providers": obj.get("providers"),
            "simple": obj.get("simple"),
            "name": obj.get("name"),
            "value": obj.get("value"),
            "formDataContentDisposition": UploadTempAttachmentsRequestFilesInnerFormDataContentDisposition.from_dict(obj["formDataContentDisposition"]) if obj.get("formDataContentDisposition") is not None else None,

...
class AttributeContent(BaseModel):
    ...
    end_user_customization: Optional[EndUserCustomization] = Field(default=None, alias="endUserCustomization")
    values: Optional[List[AttributeContentValue]] = None
    ...
    advanced_settings: Optional[AttributeContentAdvancedSettings] = Field(default=None, alias="advancedSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "endUserCustomization": EndUserCustomization.from_dict(obj["endUserCustomization"]) if obj.get("endUserCustomization") is not None else None,
            "values": [AttributeContentValue.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None,
            "required": obj.get("required"),
            "footerText": obj.get("footerText"),
            "tooltipText": obj.get("tooltipText"),
            "advancedSettings": AttributeContentAdvancedSettings.from_dict(obj["advancedSettings"]) if obj.get("advancedSettings") is not None else None
        })
        return _obj

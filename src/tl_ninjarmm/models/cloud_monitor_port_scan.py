...
class CloudMonitorPortScan(BaseModel):
    """
    ...
    target: Optional[StrictStr] = Field(default=None, description="Monitoring target (hostname, IP address or URL)")
    __properties: ClassVar[List[str]] = ["id", "parentDeviceId", "organizationId", "locationId", "nodeClass", "nodeRoleId", "rolePolicyId", "policyId", "approvalStatus", "offline", "displayName", "systemName", "dnsName", "netbiosName", "created", "lastContact", "lastUpdate", "userData", "tags", "fields", "maintenance", "references", "ipAddresses", "macAddresses", "publicIP", "notes", "deviceType", "enabled", "interval", "timeout", "target"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudMonitorPortScan from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudMonitorPortScan from a dict"""
        if obj is None:
            return None

...
class AgentDevice(BaseModel):
    ...
    os: Optional[AgentDeviceAllOfOs] = None
    system: Optional[AgentDeviceAllOfSystem] = None
    memory: Optional[AgentDeviceAllOfMemory] = None
    processors: Optional[List[GetDeviceProcessorsDefaultResponseInner]] = Field(default=None, description="Processors")
    volumes: Optional[List[GetDeviceVolumesDefaultResponseInner]] = Field(default=None, description="Disk Volumes")
    last_logged_in_user: Optional[StrictStr] = Field(default=None, description="Username that logged in most recently", alias="lastLoggedInUser")
    __properties: ClassVar[List[str]] = ["id", "parentDeviceId", "organizationId", "locationId", "nodeClass", "nodeRoleId", "rolePolicyId", "policyId", "approvalStatus", "offline", "displayName", "systemName", "dnsName", "netbiosName", "created", "lastContact", "lastUpdate", "userData", "tags", "fields", "maintenance", "references", "ipAddresses", "macAddresses", "publicIP", "notes", "deviceType", "os", "system", "memory", "processors", "volumes", "lastLoggedInUser"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "os": AgentDeviceAllOfOs.from_dict(obj["os"]) if obj.get("os") is not None else None,
            "system": AgentDeviceAllOfSystem.from_dict(obj["system"]) if obj.get("system") is not None else None,
            "memory": AgentDeviceAllOfMemory.from_dict(obj["memory"]) if obj.get("memory") is not None else None,
            "processors": [GetDeviceProcessorsDefaultResponseInner.from_dict(_item) for _item in obj["processors"]] if obj.get("processors") is not None else None,
            "volumes": [GetDeviceVolumesDefaultResponseInner.from_dict(_item) for _item in obj["volumes"]] if obj.get("volumes") is not None else None,

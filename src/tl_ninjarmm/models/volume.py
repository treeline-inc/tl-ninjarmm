...
class Volume(BaseModel):
    ...
    bit_locker_status: Optional[VolumeBitLockerStatus] = Field(default=None, alias="bitLockerStatus")
    __properties: ClassVar[List[str]] = ["name", "driveLetter", "label", "deviceType", "fileSystem", "autoMount", "compressed", "capacity", "freeSpace", "serialNumber", "bitLockerStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bitLockerStatus": VolumeBitLockerStatus.from_dict(obj["bitLockerStatus"]) if obj.get("bitLockerStatus") is not None else None
        })
        return _obj

...
class NewTicket(BaseModel):
    ...
    client_id: StrictInt = Field(
        description="Client (Organization) identifier", alias="clientId"
    )
    ticket_form_id: StrictInt = Field(
        description="Ticket form identifier", alias="ticketFormId"
    )
    location_id: Optional[StrictInt] = Field(
        default=None, description="Location identifier", alias="locationId"
    )
    node_id: Optional[StrictInt] = Field(
        default=None, description="Device identifier", alias="nodeId"
    )
    subject: Annotated[str, Field(min_length=0, strict=True, max_length=200)]
    description: Optional[NewTicketLogEntry] = None
    status: StrictStr
    type: Optional[StrictStr] = Field(default=None, description="Type of ticket")
    cc: Optional[CarbonCopy] = None
    assigned_app_user_id: Optional[StrictInt] = Field(
        default=None, alias="assignedAppUserId"
    )
    requester_uid: Optional[StrictStr] = Field(default=None, alias="requesterUid")
    severity: Optional[StrictStr] = "NONE"
    priority: Optional[StrictStr] = "NONE"
    parent_ticket_id: Optional[StrictInt] = Field(
        default=None, description="Ticket parent identifier", alias="parentTicketId"
    )
    tags: Optional[List[Optional[StrictStr]]] = None
    attributes: Optional[List[Optional[TicketingAttributeValue]]] = None
    additional_assigned_technician_ids: Optional[List[Optional[StrictInt]]] = Field(
        default=None,
        description="Additional assigned technician identifiers",
        alias="additionalAssignedTechnicianIds",
    )
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(["PROBLEM", "QUESTION", "INCIDENT", "TASK"]):
            raise ValueError(
                "must be one of enum values ('PROBLEM', 'QUESTION', 'INCIDENT', 'TASK')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.assigned_app_user_id is None
            and "assigned_app_user_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.parent_ticket_id is None
            and "parent_ticket_id" in self.model_fields_set
        ):
        ...
        # set to None if additional_assigned_technician_ids (nullable) is None
        # and model_fields_set contains the field
        if (
            self.additional_assigned_technician_ids is None
            and "additional_assigned_technician_ids" in self.model_fields_set
        ):
            _dict["additionalAssignedTechnicianIds"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "description": NewTicketLogEntry.from_dict(obj["description"])
                ...
                "type": obj.get("type"),
                "cc": CarbonCopy.from_dict(obj["cc"])
                ...
                "tags": obj.get("tags"),
                "attributes": [
                    TicketingAttributeValue.from_dict(_item)
                    for _item in obj["attributes"]
                ]
                if obj.get("attributes") is not None
                else None,
                "additionalAssignedTechnicianIds": obj.get(
                    "additionalAssignedTechnicianIds"
                ),
            }
        )

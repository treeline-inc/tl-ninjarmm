...
class OrganizationWithLocationsAndPolicyAssignmentsModel(BaseModel):
    ...
    locations: Optional[List[LocationModel]] = Field(default=None, description="List of locations")
    policies: Optional[List[NodeRolePolicyAssignment]] = Field(default=None, description="Node role policy assignments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "locations": [LocationModel.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None,
            "policies": [NodeRolePolicyAssignment.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj

...
class OrganizationWithLocationsAndPolicyAssignmentsModel(BaseModel):
    """
    OrganizationWithLocationsAndPolicyAssignmentsModel
    """  # noqa: E501

    name: Optional[StrictStr] = Field(
        default=None, description="Organization full name"
    )
    ...
    node_approval_mode: Optional[StrictStr] = Field(
        default=None, description="Device Approval Mode", alias="nodeApprovalMode"
    )
    ...
    policies: Optional[List[NodeRolePolicyAssignment]] = Field(
        default=None, description="Node role policy assignments"
    )
    ...
    def node_approval_mode_validate_enum(cls, value):
        ...
        if value not in set(["AUTOMATIC", "MANUAL", "REJECT"]):
            raise ValueError(
                "must be one of enum values ('AUTOMATIC', 'MANUAL', 'REJECT')"
            )
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationWithLocationsAndPolicyAssignmentsModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationWithLocationsAndPolicyAssignmentsModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "locations": [
                    LocationModel.from_dict(_item) for _item in obj["locations"]
                ]
                if obj.get("locations") is not None
                else None,
                "policies": [
                    NodeRolePolicyAssignment.from_dict(_item)
                    for _item in obj["policies"]
                ]

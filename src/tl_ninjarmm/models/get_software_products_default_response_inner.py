...
class GetSoftwareProductsDefaultResponseInner(BaseModel):
    """
    GetSoftwareProductsDefaultResponseInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Product identifier")
    vendor_name: Optional[StrictStr] = Field(default=None, description="Vendor Name", alias="vendorName")
    ...
    __properties: ClassVar[List[str]] = ["id", "vendorName", "productName", "installable", "active"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSoftwareProductsDefaultResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSoftwareProductsDefaultResponseInner from a dict"""
        if obj is None:
            return None

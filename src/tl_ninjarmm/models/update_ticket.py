...
class UpdateTicket(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["version", "clientId", "ticketFormId", "locationId", "nodeId", "subject", "status", "type", "cc", "assignedAppUserId", "requesterUid", "severity", "priority", "parentTicketId", "tags", "attributes"]

...
class RoleMember(BaseModel):
    ...
    source: Optional[StrictStr] = Field(default=None, description="Source of role assignment")
    __properties: ClassVar[List[str]] = ["id", "email", "name", "source"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RoleMember from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RoleMember from a dict"""
        if obj is None:
            return None

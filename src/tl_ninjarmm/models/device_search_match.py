...
class DeviceSearchMatch(BaseModel):
    ...
    assigned_owner_uid: Optional[StrictStr] = Field(default=None, description="Node (Device) Owner UUID", alias="assignedOwnerUid")
    ...
    match_attr: Optional[StrictStr] = Field(default=None, description="Name of the attribute that matched the query", alias="matchAttr")
    match_attr_value: Optional[StrictStr] = Field(default=None, description="Value of that attribute that matched", alias="matchAttrValue")
    __properties: ClassVar[List[str]] = ["id", "uid", "assignedOwnerUid", "parentDeviceId", "organizationId", "locationId", "nodeClass", "nodeRoleId", "rolePolicyId", "policyId", "approvalStatus", "offline", "displayName", "systemName", "dnsName", "netbiosName", "created", "lastContact", "lastUpdate", "userData", "tags", "fields", "maintenance", "references", "score", "matchAttr", "matchAttrValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maintenance": Maintenance.from_dict(obj["maintenance"]) if obj.get("maintenance") is not None else None,
            "references": NodeReferences.from_dict(obj["references"]) if obj.get("references") is not None else None,
            "score": obj.get("score"),

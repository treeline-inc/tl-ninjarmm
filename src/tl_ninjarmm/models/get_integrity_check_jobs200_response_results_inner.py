...
class GetIntegrityCheckJobs200ResponseResultsInner(BaseModel):
    """
    ...
    organization_id: Optional[StrictInt] = Field(default=None, description="Organization id", alias="organizationId")
    location_id: Optional[StrictInt] = Field(default=None, description="Location id", alias="locationId")
    device_id: Optional[StrictInt] = Field(default=None, description="Device id", alias="deviceId")
    __properties: ClassVar[List[str]] = ["jobId", "jobStartTime", "jobEndTime", "jobStatus", "planGuid", "planName", "planType", "totalActualStorageBytes", "organizationId", "locationId", "deviceId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetIntegrityCheckJobs200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetIntegrityCheckJobs200ResponseResultsInner from a dict"""
        if obj is None:
            return None

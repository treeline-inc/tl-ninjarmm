...
class CustomFieldsPolicyConditionCreateRequest(BaseModel):
    ...
    match_all: Optional[Annotated[List[GetCustomFieldsPolicyConditionsDefaultResponseInnerMatchAllInner], Field(min_length=0, max_length=10)]] = Field(default=None, description="Custom field value must meet all conditions", alias="matchAll")
    match_any: Optional[Annotated[List[GetCustomFieldsPolicyConditionsDefaultResponseInnerMatchAllInner], Field(min_length=0, max_length=10)]] = Field(default=None, description="Custom field value must meet any conditions", alias="matchAny")

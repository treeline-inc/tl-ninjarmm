...
class CustomFieldsPolicyConditionCreateRequest(BaseModel):
    ...
    match_all: Optional[
        Annotated[List[PolicyConditionCustomField], Field(min_length=0, max_length=10)]
    ] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "matchAll": [
                    PolicyConditionCustomField.from_dict(_item)
                    for _item in obj["matchAll"]
                ]
                if obj.get("matchAll") is not None
                else None,
                "matchAny": [
                    PolicyConditionCustomField.from_dict(_item)
                    for _item in obj["matchAny"]
                ]
                if obj.get("matchAny") is not None
                else None,
            }
        )
        return _obj

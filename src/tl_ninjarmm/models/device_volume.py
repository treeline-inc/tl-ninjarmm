...
class DeviceVolume(BaseModel):
    ...
    drive_letter: Optional[StrictStr] = Field(
        default=None, description="Drive Letter", alias="driveLetter"
    )
    ...
    file_system: Optional[StrictStr] = Field(
        default=None, description="File System Type", alias="fileSystem"
    )
    auto_mount: Optional[StrictBool] = Field(
        default=None, description="Automatically Mounted", alias="autoMount"
    )
    ...
    free_space: Optional[StrictInt] = Field(
        default=None, description="Free Space (bytes)", alias="freeSpace"
    )
    serial_number: Optional[StrictStr] = Field(
        default=None, description="Serial Number", alias="serialNumber"
    )
    bit_locker_status: Optional[VolumeBitLockerStatus] = Field(
        default=None, alias="bitLockerStatus"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceVolume from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceVolume from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "bitLockerStatus": VolumeBitLockerStatus.from_dict(
                    obj["bitLockerStatus"]
                )
                if obj.get("bitLockerStatus") is not None
                else None,

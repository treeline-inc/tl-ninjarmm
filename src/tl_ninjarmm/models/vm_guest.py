...
class VMGuest(BaseModel):
    ...
    last_boot_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Last VM Boot Time", alias="lastBootTime")
    memory_size: Optional[StrictInt] = Field(default=None, description="VM Memory size (bytes)", alias="memorySize")
    cores_per_socket: Optional[StrictInt] = Field(default=None, description="Number of Cores per Socket", alias="coresPerSocket")
    cpu_cores: Optional[StrictInt] = Field(default=None, description="Total Number of CPU Cores", alias="cpuCores")
    power_state: Optional[StrictStr] = Field(default=None, description="Current power state", alias="powerState")
    tools_install_type: Optional[StrictStr] = Field(default=None, description="Guest tools installation type", alias="toolsInstallType")
    tool_status: Optional[StrictStr] = Field(default=None, description="Guest tools status", alias="toolStatus")
    tools_version: Optional[StrictStr] = Field(default=None, description="Guest tools version", alias="toolsVersion")
    guest_os_full_name: Optional[StrictStr] = Field(default=None, description="Guest OS full name", alias="guestOSFullName")
    guest_os_family: Optional[StrictStr] = Field(default=None, description="Guest OS family", alias="guestOSFamily")
    guest_osid: Optional[StrictStr] = Field(default=None, description="Guest OS identifier", alias="guestOSId")
    tools_version_status: Optional[StrictStr] = Field(default=None, description="Guest tools version status", alias="toolsVersionStatus")
    snapshot_count: Optional[StrictInt] = Field(default=None, description="Number of snapshots", alias="snapshotCount")
    snapshot_total_size: Optional[StrictInt] = Field(default=None, description="Total snapshot size (bytes)", alias="snapshotTotalSize")
    __properties: ClassVar[List[str]] = ["id", "parentDeviceId", "organizationId", "locationId", "nodeClass", "nodeRoleId", "rolePolicyId", "policyId", "approvalStatus", "offline", "displayName", "systemName", "dnsName", "netbiosName", "created", "lastContact", "lastUpdate", "userData", "tags", "fields", "maintenance", "references", "ipAddresses", "macAddresses", "publicIP", "notes", "deviceType", "files", "fullName", "lastBootTime", "memorySize", "coresPerSocket", "cpuCores", "powerState", "toolsInstallType", "toolStatus", "toolsVersion", "guestOSFullName", "guestOSFamily", "guestOSId", "toolsVersionStatus", "snapshotCount", "snapshotTotalSize"]

...
class GetLastLoggedOnUsersReportDefaultResponseResultsInner(BaseModel):
    """
    ...
    logon_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Time of logon", alias="logonTime")
    device_id: Optional[StrictInt] = Field(default=None, description="Device identifier", alias="deviceId")
    __properties: ClassVar[List[str]] = ["userName", "logonTime", "deviceId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLastLoggedOnUsersReportDefaultResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLastLoggedOnUsersReportDefaultResponseResultsInner from a dict"""
        if obj is None:
            return None

...
class CreateDefaultResponseCcList(BaseModel):
    """
    CreateDefaultResponseCcList
    """ # noqa: E501
    uids: Optional[List[StrictStr]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateDefaultResponseCcList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateDefaultResponseCcList from a dict"""
        if obj is None:
            return None

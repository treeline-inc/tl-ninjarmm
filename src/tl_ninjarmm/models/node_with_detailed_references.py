...
class NodeWithDetailedReferences(BaseModel):
    """
    Device information.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "uid", "assignedOwnerUid", "parentDeviceId", "organizationId", "locationId", "nodeClass", "nodeRoleId", "rolePolicyId", "policyId", "approvalStatus", "offline", "displayName", "systemName", "dnsName", "netbiosName", "created", "lastContact", "lastUpdate", "userData", "tags", "fields", "maintenance", "references"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodeWithDetailedReferences from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodeWithDetailedReferences from a dict"""
        if obj is None:
            return None

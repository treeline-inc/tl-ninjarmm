...
class Alert(BaseModel):
    ...
    uid: Optional[StrictStr] = Field(
        default=None, description="Alert UID (activity series UID)"
    )
    ...
    create_time: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Alert creation timestamp", alias="createTime"
    )
    update_time: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Alert last updated", alias="updateTime"
    )
    source_type: Optional[StrictStr] = Field(
        default=None, description="Alert origin", alias="sourceType"
    )

...
class ArchiveChecklistTemplate200ResponseInnerLastUpdatedBy(BaseModel):
    """
    Archive by user
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "deleted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArchiveChecklistTemplate200ResponseInnerLastUpdatedBy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArchiveChecklistTemplate200ResponseInnerLastUpdatedBy from a dict"""
        if obj is None:
            return None

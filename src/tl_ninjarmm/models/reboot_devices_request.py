...
class RebootDevicesRequest(BaseModel):
    ...
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="Stated reboot reason")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RebootDevicesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RebootDevicesRequest from a dict"""
        if obj is None:
            return None

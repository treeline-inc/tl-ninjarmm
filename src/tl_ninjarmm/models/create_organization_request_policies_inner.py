...
class CreateOrganizationRequestPoliciesInner(BaseModel):
    """
    ...
    policy_id: Optional[StrictInt] = Field(default=None, description="Policy Identifier", alias="policyId")
    __properties: ClassVar[List[str]] = ["nodeRoleId", "policyId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOrganizationRequestPoliciesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOrganizationRequestPoliciesInner from a dict"""
        if obj is None:
            return None

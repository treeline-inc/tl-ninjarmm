...
class UpdateOrganizationDocuments200ResponseInner(BaseModel):
    """
    ...
    updated_fields: Optional[List[ArchiveClientDocument200ResponseFieldsInner]] = Field(default=None, description="Updated Fields", alias="updatedFields")
    ...
    __properties: ClassVar[List[str]] = ["documentId", "documentName", "documentDescription", "documentUpdateTime", "updatedFields", "documentTemplateId", "documentTemplateName", "organizationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateOrganizationDocuments200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateOrganizationDocuments200ResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "updatedFields": [ArchiveClientDocument200ResponseFieldsInner.from_dict(_item) for _item in obj["updatedFields"]] if obj.get("updatedFields") is not None else None,

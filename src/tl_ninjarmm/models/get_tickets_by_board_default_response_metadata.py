...
class GetTicketsByBoardDefaultResponseMetadata(BaseModel):
    """
    ...
    attributes: Optional[Dict[str, GetTicketsByBoardDefaultResponseMetadataAttributesValue]] = None
    ...
    column_names_for_exporting: Optional[List[StrictStr]] = Field(default=None, alias="columnNamesForExporting")
    all_required_columns: Optional[List[StrictStr]] = Field(default=None, alias="allRequiredColumns")
    __properties: ClassVar[List[str]] = ["columns", "sortBy", "attributes", "filters", "allColumns", "columnNamesForExporting", "allRequiredColumns"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTicketsByBoardDefaultResponseMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTicketsByBoardDefaultResponseMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "attributes": dict(
                (_k, GetTicketsByBoardDefaultResponseMetadataAttributesValue.from_dict(_v))

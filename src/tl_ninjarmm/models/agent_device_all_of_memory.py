...
class AgentDeviceAllOfMemory(BaseModel):
    """
    Memory information
    """ # noqa: E501
    capacity: Optional[StrictInt] = Field(default=None, description="Capacity")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentDeviceAllOfMemory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentDeviceAllOfMemory from a dict"""
        if obj is None:
            return None

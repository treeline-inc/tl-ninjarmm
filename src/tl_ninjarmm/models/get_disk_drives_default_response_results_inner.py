...
class GetDiskDrivesDefaultResponseResultsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bytesPerSector", "description", "interfaceType", "manufacturer", "mediaType", "model", "name", "partitionCount", "serialNumber", "size", "smartCapable", "status", "deviceId", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDiskDrivesDefaultResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDiskDrivesDefaultResponseResultsInner from a dict"""
        if obj is None:
            return None

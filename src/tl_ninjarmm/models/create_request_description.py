...
class CreateRequestDescription(BaseModel):
    """
    ...
    time_tracked: Optional[StrictInt] = Field(default=None, description="time in seconds", alias="timeTracked")
    duplicate_in_incidents: Optional[StrictBool] = Field(default=None, alias="duplicateInIncidents")
    __properties: ClassVar[List[str]] = ["public", "body", "htmlBody", "timeTracked", "duplicateInIncidents"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRequestDescription from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if time_tracked (nullable) is None
        # and model_fields_set contains the field
        if self.time_tracked is None and "time_tracked" in self.model_fields_set:
            _dict['timeTracked'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRequestDescription from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "duplicateInIncidents": obj.get("duplicateInIncidents")
        })
        return _obj

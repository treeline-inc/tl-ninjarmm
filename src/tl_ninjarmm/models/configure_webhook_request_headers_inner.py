...
class ConfigureWebhookRequestHeadersInner(BaseModel):
    """
    Custom HTTP Headers (i.e. Authorization)
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Header name")
    value: Optional[StrictStr] = Field(default=None, description="Header value")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigureWebhookRequestHeadersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigureWebhookRequestHeadersInner from a dict"""
        if obj is None:
            return None

...
class GetTicketFormByIdDefaultResponseContentTimerSettings(BaseModel):
    """
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['MANUAL', 'AUTO_START']):
            raise ValueError("must be one of enum values ('MANUAL', 'AUTO_START')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTicketFormByIdDefaultResponseContentTimerSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTicketFormByIdDefaultResponseContentTimerSettings from a dict"""
        if obj is None:
            return None

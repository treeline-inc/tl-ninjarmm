...
class GetOrganizationsDefaultResponseInner(BaseModel):
    """
    Organization
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "userData", "nodeApprovalMode", "tags", "fields", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetOrganizationsDefaultResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetOrganizationsDefaultResponseInner from a dict"""
        if obj is None:
            return None

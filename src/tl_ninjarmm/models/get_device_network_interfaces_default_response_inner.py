...
class GetDeviceNetworkInterfacesDefaultResponseInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["adapterName", "defaultGateway", "interfaceType", "dnsHostName", "dnsServers", "interfaceIndex", "interfaceName", "ipAddress", "linkSpeed", "macAddress", "mtu", "status", "subnetMask"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeviceNetworkInterfacesDefaultResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeviceNetworkInterfacesDefaultResponseInner from a dict"""
        if obj is None:
            return None

...
class GetPolicyOverrides1DefaultResponseResultsInner(BaseModel):
    """
    GetPolicyOverrides1DefaultResponseResultsInner
    """ # noqa: E501
    overrides: Optional[List[StrictStr]] = Field(default=None, description="List of policy sections")
    device_id: Optional[StrictInt] = Field(default=None, description="Device identifier", alias="deviceId")
    __properties: ClassVar[List[str]] = ["overrides", "deviceId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPolicyOverrides1DefaultResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPolicyOverrides1DefaultResponseResultsInner from a dict"""
        if obj is None:
            return None

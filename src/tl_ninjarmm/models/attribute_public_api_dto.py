...
class AttributePublicApiDTO(BaseModel):
    ...
    def definition_scope_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['NODE', 'END_USER', 'LOCATION', 'ORGANIZATION']):
                raise ValueError("each list item must be one of ('NODE', 'END_USER', 'LOCATION', 'ORGANIZATION')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": AttributeContent.from_dict(obj["content"]) if obj.get("content") is not None else None,

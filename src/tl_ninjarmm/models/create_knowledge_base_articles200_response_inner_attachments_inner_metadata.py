...
class CreateKnowledgeBaseArticles200ResponseInnerAttachmentsInnerMetadata(BaseModel):
    """
    Attachment metadata
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "mimeType", "size", "extension", "contentId", "inline"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateKnowledgeBaseArticles200ResponseInnerAttachmentsInnerMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateKnowledgeBaseArticles200ResponseInnerAttachmentsInnerMetadata from a dict"""
        if obj is None:
            return None

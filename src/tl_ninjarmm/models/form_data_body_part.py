...
from tl_ninjarmm.models.body_part_media_type import BodyPartMediaType
...
class FormDataBodyPart(BaseModel):
    ...
    content_disposition: Optional[ContentDisposition] = Field(
        default=None, alias="contentDisposition"
    )
    ...
    message_body_workers: Optional[Dict[str, Any]] = Field(
        default=None, alias="messageBodyWorkers"
    )
    ...
    form_data_content_disposition: Optional[FormDataContentDisposition] = Field(
        default=None, alias="formDataContentDisposition"
    )
    parameterized_headers: Optional[Dict[str, List[ParameterizedHeader]]] = Field(
        default=None, alias="parameterizedHeaders"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.form_data_content_disposition:
            _dict["formDataContentDisposition"] = (
                self.form_data_content_disposition.to_dict()
            )
            ...
            for _key_parameterized_headers in self.parameterized_headers:
                if self.parameterized_headers[_key_parameterized_headers] is not None:
                    _field_dict_of_array[_key_parameterized_headers] = [
                        _item.to_dict()
                        for _item in self.parameterized_headers[
                            _key_parameterized_headers
                        ]
                    ]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "contentDisposition": ContentDisposition.from_dict(
                    obj["contentDisposition"]
                )
                if obj.get("contentDisposition") is not None
                else None,
                "entity": obj.get("entity"),
                "headers": obj.get("headers"),
                "mediaType": BodyPartMediaType.from_dict(obj["mediaType"])
                if obj.get("mediaType") is not None
                else None,
                "messageBodyWorkers": obj.get("messageBodyWorkers"),
                "parent": MultiPart.from_dict(obj["parent"])
                ...
                "name": obj.get("name"),
                "value": obj.get("value"),
                "formDataContentDisposition": FormDataContentDisposition.from_dict(
                    obj["formDataContentDisposition"]
                )
                if obj.get("formDataContentDisposition") is not None
                else None,

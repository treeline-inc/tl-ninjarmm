...
class WindowsServiceControlRequest(BaseModel):
    """
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['START', 'PAUSE', 'STOP', 'RESTART']):
            raise ValueError("must be one of enum values ('START', 'PAUSE', 'STOP', 'RESTART')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WindowsServiceControlRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WindowsServiceControlRequest from a dict"""
        if obj is None:
            return None

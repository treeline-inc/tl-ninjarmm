...
from tl_ninjarmm.models.document_attribute_content_public_api import (
...
class DocumentItemPublicApiDTO(BaseModel):
    ...
    field_id: Optional[StrictInt] = Field(
        default=None, description="Field identifier", alias="fieldId"
    )
    field_label: Optional[StrictStr] = Field(
        default=None, description="Field or UI element name", alias="fieldLabel"
    )
    field_name: Optional[StrictStr] = Field(
        default=None, description="Field name", alias="fieldName"
    )
    field_description: Optional[StrictStr] = Field(
        default=None, description="Field description", alias="fieldDescription"
    )
    field_type: Optional[StrictStr] = Field(
        default=None, description="Field type", alias="fieldType"
    )
    field_technician_permission: Optional[StrictStr] = Field(
        default=None,
        description="Field technician permission",
        alias="fieldTechnicianPermission",
    )
    field_script_permission: Optional[StrictStr] = Field(
        default=None,
        description="Field script permission",
        alias="fieldScriptPermission",
    )
    field_api_permission: Optional[StrictStr] = Field(
        default=None,
        description="Field public API permission",
        alias="fieldApiPermission",
    )
    field_default_value: Optional[StrictStr] = Field(
        default=None, description="Default value", alias="fieldDefaultValue"
    )
    field_content: Optional[DocumentAttributeContentPublicApi] = Field(
        default=None, alias="fieldContent"
    )
    ui_element_uid: Optional[StrictStr] = Field(
        default=None, description="UI element identifier", alias="uiElementUid"
    )
    ui_element_name: Optional[StrictStr] = Field(
        default=None, description="UI element name", alias="uiElementName"
    )
    ui_element_type: Optional[StrictStr] = Field(
        default=None, description="UI element type", alias="uiElementType"
    )
    ui_element_value: Optional[StrictStr] = Field(
        default=None, description="UI element value", alias="uiElementValue"
    )
    created_time: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Creation time", alias="createdTime"
    )
    updated_time: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Last updated time", alias="updatedTime"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "fieldContent": DocumentAttributeContentPublicApi.from_dict(
                    obj["fieldContent"]
                )
                if obj.get("fieldContent") is not None
                else None,

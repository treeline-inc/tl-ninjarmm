...
class AttributeContentAdvancedSettings(BaseModel):
    ...
    date_filters: Optional[AttributeContentAdvancedSettingsDateFilters] = Field(default=None, alias="dateFilters")
    max_characters: Optional[StrictInt] = Field(default=None, alias="maxCharacters")
    complexity_rules: Optional[AttributeContentAdvancedSettingsComplexityRules] = Field(default=None, alias="complexityRules")
    numeric_range: Optional[AttributeContentAdvancedSettingsNumericRange] = Field(default=None, alias="numericRange")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dateFilters": AttributeContentAdvancedSettingsDateFilters.from_dict(obj["dateFilters"]) if obj.get("dateFilters") is not None else None,
            "maxCharacters": obj.get("maxCharacters"),
            "complexityRules": AttributeContentAdvancedSettingsComplexityRules.from_dict(obj["complexityRules"]) if obj.get("complexityRules") is not None else None,
            "numericRange": AttributeContentAdvancedSettingsNumericRange.from_dict(obj["numericRange"]) if obj.get("numericRange") is not None else None,
            "org": obj.get("org"),

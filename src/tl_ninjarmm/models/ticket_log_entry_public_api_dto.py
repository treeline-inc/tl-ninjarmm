...
from tl_ninjarmm.models.technicians_tagged_metadata_dto import (
    TechniciansTaggedMetadataDTO,
)
from tl_ninjarmm.models.ticket_log_entry_automation_dto import (
...
class TicketLogEntryPublicApiDTO(BaseModel):
    """
    TicketLogEntryPublicApiDTO
    """  # noqa: E501

    id: Optional[StrictInt] = None
    app_user_contact_uid: Optional[StrictStr] = Field(
        default=None, alias="appUserContactUid"
    )
    app_user_contact_id: Optional[StrictInt] = Field(
        default=None, alias="appUserContactId"
    )
    app_user_contact_type: Optional[StrictStr] = Field(
        default=None, alias="appUserContactType"
    )
    ...
    technician_tagged: Optional[List[StrictInt]] = Field(
        default=None, alias="technicianTagged"
    )
    technicians_tagged_metadata: Optional[List[TechniciansTaggedMetadataDTO]] = Field(
        default=None, alias="techniciansTaggedMetadata"
    )
    automation: Optional[TicketLogEntryAutomationDTO] = None
    blocked_by_invoice: Optional[StrictBool] = Field(
        default=None, alias="blockedByInvoice"
    )
    ticket_time_entry: Optional[TicketTimeEntryDTO] = Field(
        default=None, alias="ticketTimeEntry"
    )
    ...
    def app_user_contact_type_validate_enum(cls, value):
        ...
        if value not in set(["TECHNICIAN", "END_USER", "CONTACT"]):
            raise ValueError(
                "must be one of enum values ('TECHNICIAN', 'END_USER', 'CONTACT')"
            )
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(
            ["DESCRIPTION", "COMMENT", "CONDITION", "SAVE", "DELETE", "PRODUCT"]
        ):
            raise ValueError(
                "must be one of enum values ('DESCRIPTION', 'COMMENT', 'CONDITION', 'SAVE', 'DELETE', 'PRODUCT')"
            )
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TicketLogEntryPublicApiDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TicketLogEntryPublicApiDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "techniciansTaggedMetadata": [
                    TechniciansTaggedMetadataDTO.from_dict(_item)
                    for _item in obj["techniciansTaggedMetadata"]
                ]
                if obj.get("techniciansTaggedMetadata") is not None
                else None,
                "automation": TicketLogEntryAutomationDTO.from_dict(obj["automation"])
                if obj.get("automation") is not None
                else None,
                "blockedByInvoice": obj.get("blockedByInvoice"),
                "ticketTimeEntry": TicketTimeEntryDTO.from_dict(obj["ticketTimeEntry"])
                if obj.get("ticketTimeEntry") is not None
                else None,

...
class NodeAttributeInfo(BaseModel):
    """
    Field values
    """  # noqa: E501
    ...
    updated: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="Last field update timestamp"
    )
    updated_by: Optional[AttributeValueUpdatedByInfo] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodeAttributeInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodeAttributeInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "updatedBy": AttributeValueUpdatedByInfo.from_dict(obj["updatedBy"])

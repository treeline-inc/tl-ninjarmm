...
class GetDeviceGlobalCustomFieldsDefaultResponseInner(BaseModel):
    """
    ...
    definition_scope: Optional[List[StrictStr]] = Field(default=None, description="Definition Scope", alias="definitionScope")
    ...
    end_user_permission: Optional[StrictStr] = Field(default=None, description="End User Permission", alias="endUserPermission")
    technician_permission: Optional[StrictStr] = Field(default=None, description="Technician Permission", alias="technicianPermission")
    script_permission: Optional[StrictStr] = Field(default=None, description="Script Permission", alias="scriptPermission")
    api_permission: Optional[StrictStr] = Field(default=None, description="Public API Permission", alias="apiPermission")
    ...
    create_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Create Time", alias="createTime")
    update_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Update Time", alias="updateTime")
    __properties: ClassVar[List[str]] = ["entityType", "scope", "definitionScope", "type", "label", "description", "name", "defaultValue", "endUserPermission", "technicianPermission", "scriptPermission", "apiPermission", "content", "system", "active", "createTime", "updateTime"]
    ...
    def entity_type_validate_enum(cls, value):
        ...
        if value not in set(['USER', 'NODE', 'TICKET', 'DOCUMENT']):
            raise ValueError("must be one of enum values ('USER', 'NODE', 'TICKET', 'DOCUMENT')")
        return value
    ...
    def scope_validate_enum(cls, value):
        ...
        if value not in set(['NODE_GLOBAL', 'NODE_ROLE', 'NODE_CLASS']):
            raise ValueError("must be one of enum values ('NODE_GLOBAL', 'NODE_ROLE', 'NODE_CLASS')")
        return value
    ...
    def definition_scope_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['NODE', 'LOCATION', 'ORGANIZATION']):
                raise ValueError("each list item must be one of ('NODE', 'LOCATION', 'ORGANIZATION')")
        return value
    ...
    def end_user_permission_validate_enum(cls, value):
        ...
        if value not in set(['HIDDEN', 'EDITABLE_OPTIONAL', 'EDITABLE_REQUIRED', 'READ_ONLY']):
            raise ValueError("must be one of enum values ('HIDDEN', 'EDITABLE_OPTIONAL', 'EDITABLE_REQUIRED', 'READ_ONLY')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeviceGlobalCustomFieldsDefaultResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeviceGlobalCustomFieldsDefaultResponseInner from a dict"""
        if obj is None:
            return None

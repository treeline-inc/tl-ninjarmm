...
class GetDeviceLinkDefaultResponse(BaseModel):
    """
    GetDeviceLinkDefaultResponse
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="URL")
    expires: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Link expiration time")
    __properties: ClassVar[List[str]] = ["url", "expires"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeviceLinkDefaultResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeviceLinkDefaultResponse from a dict"""
        if obj is None:
            return None

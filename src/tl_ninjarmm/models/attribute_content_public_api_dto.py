...
class AttributeContentPublicApiDTO(BaseModel):
    """
    For multi-select attributes, these are the available content options
    """  # noqa: E501

    customize_for_end_user: Optional[StrictBool] = Field(
        default=None,
        description="Whether the attribute should be customized for end users",
        alias="customizeForEndUser",
    )
    end_user_customization: Optional[EndUserCustomization] = Field(
        default=None, alias="endUserCustomization"
    )
    values: Optional[List[AttributeContentValue]] = Field(
        default=None,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeContentPublicApiDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeContentPublicApiDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "endUserCustomization": EndUserCustomization.from_dict(
                    obj["endUserCustomization"]
                )
                if obj.get("endUserCustomization") is not None
                else None,
                "values": [
                    AttributeContentValue.from_dict(_item) for _item in obj["values"]
                ]

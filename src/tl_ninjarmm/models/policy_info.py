...
class PolicyInfo(BaseModel):
    ...
    enabled: Optional[StrictBool] = Field(default=True, description="Policy Enabled Flag")
    __properties: ClassVar[List[str]] = ["parentPolicyId", "name", "description", "nodeClass", "enabled"]

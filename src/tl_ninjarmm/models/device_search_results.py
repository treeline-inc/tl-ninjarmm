...
class DeviceSearchResults(BaseModel):
    ...
    devices: Optional[List[DeviceSearchMatch]] = Field(
        default=None, description="Devices matching search query"
    )
        ...
        _obj = cls.model_validate(
            {
                "query": obj.get("query"),
                "devices": [
                    DeviceSearchMatch.from_dict(_item) for _item in obj["devices"]
                ]

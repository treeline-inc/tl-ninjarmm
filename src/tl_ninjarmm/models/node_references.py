...
class NodeReferences(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["organization", "location", "rolePolicy", "policy", "role", "backupUsage", "warranty", "assignedOwner"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rolePolicy": Policy.from_dict(obj["rolePolicy"]) if obj.get("rolePolicy") is not None else None,
            "policy": Policy.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
            "role": NodeRole.from_dict(obj["role"]) if obj.get("role") is not None else None,
            "backupUsage": BackupUsage.from_dict(obj["backupUsage"]) if obj.get("backupUsage") is not None else None,
            "warranty": WarrantyDates.from_dict(obj["warranty"]) if obj.get("warranty") is not None else None,
            "assignedOwner": User.from_dict(obj["assignedOwner"]) if obj.get("assignedOwner") is not None else None
        })
        return _obj

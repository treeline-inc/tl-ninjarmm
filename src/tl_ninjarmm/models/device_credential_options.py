...
class DeviceCredentialOptions(BaseModel):
    ...
    credentials: Optional[List[CredentialReference]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": obj.get("roles"),
            "credentials": [CredentialReference.from_dict(_item) for _item in obj["credentials"]] if obj.get("credentials") is not None else None
        })
        return _obj

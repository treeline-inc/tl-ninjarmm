...
class CreateRequestCc(BaseModel):
    """
    CreateRequestCc
    """ # noqa: E501
    uids: Optional[List[Optional[StrictStr]]] = Field(default=None, description="List of user uids to be carbon-copied")
    emails: Optional[List[Optional[StrictStr]]] = Field(default=None, description="emails")
    __properties: ClassVar[List[str]] = ["uids", "emails"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRequestCc from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if uids (nullable) is None
        # and model_fields_set contains the field
        if self.uids is None and "uids" in self.model_fields_set:
            _dict['uids'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRequestCc from a dict"""
        if obj is None:
            return None

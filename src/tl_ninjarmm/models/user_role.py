...
class UserRole(BaseModel):
    ...
    UserRole
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Role identifier")
    name: Optional[StrictStr] = Field(default=None, description="Role name")
    type: Optional[StrictStr] = Field(default=None, description="Role type")
    description: Optional[StrictStr] = Field(default=None, description="Role description")
    members: Optional[List[RoleMember]] = Field(default=None, description="Role members")
    __properties: ClassVar[List[str]] = ["id", "name", "type", "description", "members"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "members": [RoleMember.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj

...
class CloudMonitorEmailServer(BaseModel):
    """
    ...
    interval: Optional[StrictInt] = Field(default=None, description="Monitoring interval (seconds)")
    timeout: Optional[StrictInt] = Field(default=None, description="Timeout (seconds)")
    target: Optional[StrictStr] = Field(default=None, description="SMTP Host (hostname or IP address)")
    smtp_port: Optional[StrictInt] = Field(default=None, description="SMTP Port", alias="smtpPort")
    sender_email: Optional[StrictStr] = Field(default=None, description="Sender's email (FROM)", alias="senderEmail")
    recipient_email: Optional[StrictStr] = Field(default=None, description="Recipient's email (TO)", alias="recipientEmail")
    __properties: ClassVar[List[str]] = ["id", "parentDeviceId", "organizationId", "locationId", "nodeClass", "nodeRoleId", "rolePolicyId", "policyId", "approvalStatus", "offline", "displayName", "systemName", "dnsName", "netbiosName", "created", "lastContact", "lastUpdate", "userData", "tags", "fields", "maintenance", "references", "ipAddresses", "macAddresses", "publicIP", "notes", "deviceType", "enabled", "interval", "timeout", "target", "smtpPort", "senderEmail", "recipientEmail"]

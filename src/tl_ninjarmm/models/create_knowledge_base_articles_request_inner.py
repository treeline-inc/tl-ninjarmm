...
class CreateKnowledgeBaseArticlesRequestInner(BaseModel):
    """
    ...
    destination_folder_id: Optional[StrictInt] = Field(default=None, description="Destination folder identifier", alias="destinationFolderId")
    destination_folder_path: Optional[StrictStr] = Field(default=None, description="Folder path, each folder name separated by '|'", alias="destinationFolderPath")
    content: Optional[CreateKnowledgeBaseArticlesRequestInnerContent] = None
    __properties: ClassVar[List[str]] = ["name", "organizationId", "destinationFolderId", "destinationFolderPath", "content"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateKnowledgeBaseArticlesRequestInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateKnowledgeBaseArticlesRequestInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "destinationFolderPath": obj.get("destinationFolderPath"),

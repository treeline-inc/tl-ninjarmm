...
class WindowsEventPolicyConditionResponse(BaseModel):
    ...
    scripts: Optional[List[PolicyConditionScript]] = Field(default=None, description="Policy condition scripts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inheritance": PolicyConditionInheritanceStatus.from_dict(obj["inheritance"]) if obj.get("inheritance") is not None else None,

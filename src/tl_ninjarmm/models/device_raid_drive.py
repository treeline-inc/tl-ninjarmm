...
class DeviceRAIDDrive(BaseModel):
    ...
    drive_group: Optional[StrictStr] = Field(
        default=None, description="Drive Group", alias="driveGroup"
    )
    drive_id: Optional[StrictStr] = Field(
        default=None, description="Drive Identifier", alias="driveId"
    )
    ...
    protection_info: Optional[StrictStr] = Field(
        default=None, description="Protection Information", alias="protectionInfo"
    )
    self_encrypted: Optional[StrictBool] = Field(
        default=None, description="Is self encrypted?", alias="selfEncrypted"
    )

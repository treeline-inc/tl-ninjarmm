...
import tl_ninjarmm.models
from tl_ninjarmm import rest
from tl_ninjarmm.exceptions import (
    ApiValueError,
    ApiException,
)
...
class ApiClient:
    ...
    def __init__(
        ...
        # Thread safety: Single lock for token refresh operations
    ...
    def _refresh_token_if_needed(self) -> None:
        ...
        This method is thread-safe and prevents multiple simultaneous token fetches
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(tl_ninjarmm.models, klass)

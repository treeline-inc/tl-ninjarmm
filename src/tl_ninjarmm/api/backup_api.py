...
from tl_ninjarmm.models.lockhart_integrity_check_job_creation_request import (
    LockhartIntegrityCheckJobCreationRequest,
)
from tl_ninjarmm.models.lockhart_integrity_check_job_creation_response import (
...
class BackupApi:
    ...
    def get_backup_jobs(
        ...
        ddf: Annotated[
            Optional[StrictStr], Field(description="Deleted device filter")
        ] = None,
        sf: Annotated[
            Optional[StrictStr], Field(description="Backup job status filter")
        ] = None,
        ptf: Annotated[
            Optional[StrictStr], Field(description="Backup job planType filter")
        ] = None,
        stf: Annotated[
            Optional[StrictStr], Field(description="Backup job startTime filter")
        ] = None,
        include: Annotated[
            Optional[StrictStr],
            Field(
    ...
    def get_integrity_check_jobs(
        ...
        cursor: Annotated[
            Optional[StrictStr], Field(description="Cursor name.")
        ] = None,
        page_size: Annotated[
            Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]],
            Field(description="Limit number of records per page."),
    ...
    def submit_integrity_check_job(
        self,
        lockhart_integrity_check_job_creation_request: Optional[
            LockhartIntegrityCheckJobCreationRequest
        ] = None,
        _request_timeout: Union[
            None,
        ...
        :param lockhart_integrity_check_job_creation_request:
        :type lockhart_integrity_check_job_creation_request: LockhartIntegrityCheckJobCreationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._submit_integrity_check_job_serialize(
            lockhart_integrity_check_job_creation_request=lockhart_integrity_check_job_creation_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "LockhartIntegrityCheckJobCreationResponse",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    def submit_integrity_check_job_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LockhartIntegrityCheckJobCreationResponse]:
        """Create an integrity check job
    ...
    def _submit_integrity_check_job_serialize(
        self,
        lockhart_integrity_check_job_creation_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if lockhart_integrity_check_job_creation_request is not None:
            _body_params = lockhart_integrity_check_job_creation_request

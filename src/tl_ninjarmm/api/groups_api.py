...
class GroupsApi:
    ...
    def get_group_device_ids(
        self,
        id: Annotated[StrictInt, Field(description="Group identifier")],
        ...
        _param = self._get_group_device_ids_serialize(
            id=id,
    ...
    @validate_call
    def get_group_device_ids_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Group identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_group_device_ids_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Group identifier")],
        _request_timeout: Union[
            None,
    ...
    def _get_group_device_ids_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v2/group/{id}/device-ids",

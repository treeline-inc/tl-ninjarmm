...
class WebhooksApi:
    ...
    def configure_webhook(
        ...
        :param webhook_configuration:
        :type webhook_configuration: WebhookConfiguration
    ...
    def _configure_webhook_serialize(
        ...
        if webhook_configuration is not None:
            _body_params = webhook_configuration
    ...
    def disable_webhook(
        ...
        _param = self._disable_webhook_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def disable_webhook_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def disable_webhook_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _disable_webhook_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
